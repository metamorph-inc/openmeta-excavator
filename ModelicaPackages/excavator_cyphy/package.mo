...
package excavator_cyphy 
  package excavator
    ...
    MB.Sensors.RelativePosition relativePosition annotation (Placement(
          ...
          rotation=90,
          origin={32,130})));
      cyPhy_Excavator.components.boomCylR boomcylR1(
                                                   boom_s_init=boom_s_init)
                                                  annotation (Placement(
            transformation(rotation=0, extent={{178,186},{212,214}})));
    MB.Parts.Fixed fixed1
      annotation (Placement(transformation(extent={{168,234},{188,254}})));
    equation
    //--------------------------------------------------------
    // HydraulicSubSyst equations
    //--------------------------------------------------------
    ...
    connect(boomValve.u, digCycleSeq.y1) annotation (Line(
        ...
        color={0,0,127},
        smooth=Smooth.None));
    connect(boomcylR.frame_b, boom1.frame_b2) annotation (Line(
        points={{138.06,141.565},{138.06,164.96},{105.6,164.96}},
        color={95,95,95},
        thickness=0.5,
        smooth=Smooth.None));
    connect(boomcylR.frame_b, boomcylR1.frame_a) annotation (Line(
        points={{138.06,141.565},{167.03,141.565},{167.03,188.435},{196.36,
            188.435}},
        color={95,95,95},
        thickness=0.5,
        smooth=Smooth.None));
    connect(fixed1.frame_b, boomcylR1.frame_b) annotation (Line(
        points={{188,244},{196,244},{196,242},{198.06,242},{198.06,211.565}},
        color={95,95,95},
        thickness=0.5,
        smooth=Smooth.None));
      annotation (Diagram(coordinateSystem(extent={{-160,-200},{520,360}},
    ...
    import MB = Modelica.Mechanics.MultiBody;
      ...
      inner MB.World world
        annotation (Placement(transformation(extent={{-10,-10},{10,10}},
            rotation=90,
            origin={-110,286})));
      cyPhy_Excavator.components.cyl cylR(initType=Modelica.Mechanics.MultiBody.Types.Init.Free,
        hasParallel=true) annotation (Placement(transformation(rotation=0,
            extent={{118,116},{152,144}})));
      cyPhy_Excavator.components.carriage     carriage1 annotation (Placement(
            transformation(rotation=0, extent={{78,80},{98,100}})));
      cyPhy_Excavator.components.armCyl     armCyl1(arm_s_init=arm_s_init)
        annotation (Placement(transformation(rotation=0, extent={{130,210},{164,
    ...
    cyPhy_Excavator.excavator.linearDistance linearDistance1 annotation (
        Placement(transformation(rotation=0, extent={{-72,198},{-52,218}})));
    Modelica.Blocks.Continuous.LimPID PID(
      initType=Modelica.Blocks.Types.InitPID.NoInit,
      yMax=1,
      Td=0.01,
    ...
    Modelica.Blocks.Continuous.LimPID PID2(
      ...
      controllerType=Modelica.Blocks.Types.SimpleController.P,
      k=1)
      annotation (Placement(transformation(extent={{424,-124},{404,-144}})));
    Modelica.Blocks.Sources.TimeTable timeTable2(table=[0,1; 5,0; 10,0; 12,0])
      annotation (Placement(transformation(extent={{494,-112},{474,-92}})));
    cyPhy_Excavator.components.BucketAngle bucketAngle annotation (Placement(
          transformation(rotation=0, extent={{192,340},{212,360}})));
    Modelica.Blocks.Continuous.Derivative derivative(k=-1)
      annotation (Placement(transformation(extent={{250,-190},{270,-170}})));
    Modelica.Blocks.Sources.Constant const3(k=25)
      annotation (Placement(transformation(extent={{-112,226},{-92,246}})));
    Modelica.Blocks.Sources.Trapezoid trapezoid(
      ...
      width=3,
      period=8)
      annotation (Placement(transformation(extent={{352,-176},{372,-156}})));
    MB.Parts.FixedRotation fixedRotation(n={0,0,1}, angle=0)
      annotation (Placement(transformation(extent={{34,4},{60,30}})));
    cyPhy_Excavator.components.cyl cyl(cyl_s_init=boom_s_init)
      annotation (Placement(transformation(extent={{30,130},{10,152}})));
    equation
    //--------------------------------------------------------
    // HydraulicSubSyst equations
    //--------------------------------------------------------
    ...
    connect(jB.port[2], cylR.port_b) annotation (Line(points={{136,-24},{162,
            -24},{162,117.704},{150.98,117.704}}, color={255,0,0}));
      connect(boomValve.portB, boomLineB.port_a)
                                             annotation (Line(points={{134.8,-96},{136,
              -96},{136,-74}},          color={255,0,0}));
      connect(boomValve.portA, boomLineA.port_a)
      ...
      connect(swingValve.portB, swingLineB.port_a)
              ...
              -96},{94,-74}},           color={255,0,0}));
      connect(swingLineA.port_b, swingMotor.portB)
                                        annotation (Line(points={{78,-54},{-38,
            -54},{-38,-62}},     color={255,0,0}));
      connect(swingLineB.port_b, swingMotor.portA)
                                         annotation (Line(points={{94,-54},{94,
            -42},{-2,-42},{-38,-42}},
                                 color={255,0,0}));
    ...
    // Top level connections
      ...
      connect(swingMotor.flange_b,carriage1.axis)      annotation (Line(
          points={{-47.8,-52},{-54,-52},{-54,80},{78,80}},
          color={0,0,0},
          smooth=Smooth.None));
    connect(carriage1.frame_b1, cylR.frame_a) annotation (Line(
        points={{97.4,92},{136.36,92},{136.36,118.435}},
        color={95,95,95},
        thickness=0.5,
        smooth=Smooth.None));
      ...
      connect(arm1.frame_b3, armCyl1.frame_b) annotation (Line(
          ...
          thickness=0.5,
          smooth=Smooth.None));
    connect(boom1.frame_b2, cylR.frame_b) annotation (Line(
        points={{105.6,164.96},{138.06,164.96},{138.06,141.565}},
        color={95,95,95},
        thickness=0.5,
        smooth=Smooth.None));
      connect(boom1.frame_b3, armCyl1.frame_a) annotation (Line(
          ...
          thickness=0.5,
          smooth=Smooth.None));
    connect(jA.port[2], cylR.port_a) annotation (Line(
        points={{120,-40},{188,-40},{188,142.296},{148.94,142.296}},
        color={255,0,0},
        smooth=Smooth.None));
    connect(PID.u_s, timeTable.y) annotation (Line(
    ...
    connect(PID1.u_s, timeTable1.y) annotation (Line(
        ...
        smooth=Smooth.None));
    connect(linearDistance1.frame_b, bucket1.bucket_tip) annotation (Line(
        points={{-52,212},{16,212},{16,248},{56,248},{56,342},{90,342},{90,
            331.32}},
        color={95,95,95},
        thickness=0.5,
        smooth=Smooth.None));
    connect(linearDistance1.frame_a, undercarriage.frame_a) annotation (Line(
        points={{-52,206},{-38,206},{-38,178},{-132,178},{-132,36},{86,36},{86,
            38}},
        color={95,95,95},
        thickness=0.5,
        smooth=Smooth.None));
      connect(bucketAngle.frame_a,    bucket1.bucket_tip) annotation (Line(
          ...
          thickness=0.5,
          smooth=Smooth.None));
    connect(cylR.cylLength_unit, PID.u_m) annotation (Line(
        points={{116.3,121.6},{243.15,121.6},{243.15,104},{370,104}},
        color={0,0,127},
        smooth=Smooth.None));
      connect(armCyl1.cylLength_unit, PID1.u_m) annotation (Line(
          ...
          smooth=Smooth.None));
      connect(bucketCyl1.cylLength_unit, PID2.u_m) annotation (Line(
          points={{141.793,314.714},{128,314.714},{128,270},{510,270},{510,-78},
            {414,-78},{414,-122}},
          color={0,0,127},
          smooth=Smooth.None));
    connect(bucketValve.y[1], derivative.u) annotation (Line(
        points={{313.1,-100.5},{299.55,-100.5},{299.55,-180},{248,-180}},
        color={0,0,127},
        smooth=Smooth.None));
    connect(timeTable2.y, PID2.u_s) annotation (Line(
        points={{473,-102},{452,-102},{452,-134},{426,-134}},
        color={0,0,127},
        smooth=Smooth.None));
    connect(const3.y, bucket1.load) annotation (Line(
        points={{-91,236},{-14,236},{-14,311.6},{64,311.6}},
        color={0,0,127},
        smooth=Smooth.None));
    connect(fixed.frame_b, fixedRotation.frame_a) annotation (Line(
        points={{6,16},{24,16},{24,17},{34,17}},
        color={95,95,95},
        thickness=0.5,
        smooth=Smooth.None));
    connect(undercarriage.frame_a, fixedRotation.frame_b) annotation (Line(
        points={{86,38},{86,17},{60,17}},
        color={95,95,95},
        thickness=0.5,
        smooth=Smooth.None));
    connect(PID.y, boomValve.u[1]) annotation (Line(
        points={{359,92},{250.5,92},{250.5,-100.5},{142.9,-100.5}},
        color={0,0,127},
        smooth=Smooth.None));
    connect(PID1.y, armValve.u[1]) annotation (Line(
        points={{413,-46},{294,-46},{294,-100.5},{286.9,-100.5}},
        color={0,0,127},
        smooth=Smooth.None));
    connect(PID2.y, bucketValve.u[1]) annotation (Line(
        points={{403,-134},{375.5,-134},{375.5,-100.5},{344.9,-100.5}},
        color={0,0,127},
        smooth=Smooth.None));
    connect(cyl.frame_b, boom1.frame_b1) annotation (Line(
        points={{18.2,150.087},{18.2,164.96},{66,164.96}},
        color={95,95,95},
        thickness=0.5,
        smooth=Smooth.None));
    connect(cyl.frame_a, carriage1.frame_b) annotation (Line(
        points={{19.2,131.913},{19.2,92.2},{78.8,92.2}},
        color={95,95,95},
        thickness=0.5,
        smooth=Smooth.None));
    connect(jB.port[3], cyl.port_b) annotation (Line(
        points={{136,-23.3333},{-18,-23.3333},{-18,131.339},{10.6,131.339}},
        color={255,0,0},
        smooth=Smooth.None));
    connect(jA.port[3], cyl.port_a) annotation (Line(
        points={{120,-39.3333},{120,-28},{-30,-28},{-30,150.661},{11.8,150.661}},
        color={255,0,0},
        smooth=Smooth.None));
    ...
    MB.Parts.Fixed fixed
      annotation (Placement(transformation(extent={{34,16},{54,36}})));
    cyPhy_Excavator.excavator.linearDistance linearDistance1 annotation (
        Placement(transformation(rotation=0, extent={{-28,228},{-8,248}})));
    Modelica.Blocks.Continuous.LimPID PID(
      initType=Modelica.Blocks.Types.InitPID.NoInit,
      yMax=1,
      Td=0.01,
    ...
    Modelica.Blocks.Sources.Constant const
      ...
      height=0,
      offset=-60000)
        annotation (Placement(transformation(extent={{324,304},{304,324}})));
    ...
    Modelica.Blocks.Sources.Pulse pulse(nperiod=2)
      annotation (Placement(transformation(extent={{-168,206},{-148,226}})));
    equation
    //--------------------------------------------------------
    // HydraulicSubSyst equations
    //--------------------------------------------------------
    ...
    connect(PID1.u_s, timeTable1.y) annotation (Line(
        ...
        smooth=Smooth.None));
    connect(linearDistance1.frame_a, undercarriage.frame_a) annotation (Line(
        points={{-8,236},{14,236},{14,214},{66,214},{66,36},{86,36},{86,38}},
        color={95,95,95},
        thickness=0.5,
        smooth=Smooth.None));
      connect(boomcylR.cylLength_unit, PID.u_m) annotation (Line(
      ...
      connect(linearDistance1.frame_b, arm1.frame_b2) annotation (Line(
          points={{-8,242},{34,242},{34,288},{84.28,288},{84.28,286.6}},
          color={95,95,95},
          thickness=0.5,
          smooth=Smooth.None));
    ...
    connect(force1.yForce, ramp.y) annotation (Line(
        points={{130.8,324},{218,324},{218,314},{303,314}},
        color={0,0,127},
        smooth=Smooth.None));
      annotation (Diagram(coordinateSystem(extent={{-160,-200},{520,360}},
              preserveAspectRatio=false),
    ...
    import MB = Modelica.Mechanics.MultiBody;
      ...
      cyPhy_Excavator.components.carriage     carriage1 annotation (Placement(
            transformation(rotation=0, extent={{78,80},{98,100}})));
      cyPhy_Excavator.components.armCyl     armCyl1(arm_s_init=arm_s_init)
        annotation (Placement(transformation(rotation=0, extent={{132,212},{166,240}})));
      cyPhy_Excavator.components.bucketCyl     bucketCyl1(bucket_s_init=
            bucket_s_init) annotation (Placement(transformation(rotation=0, extent={{142,302},
                {172,330}})));
      cyPhy_Excavator.components.boom     boom1 annotation (Placement(
    ...
    Modelica.Blocks.Sources.Ramp ramp(
      ...
      duration=200,
      height=5000)
      annotation (Placement(transformation(extent={{-82,236},{-62,256}})));
    MB.Sensors.AbsoluteAngles absoluteAngles
      annotation (Placement(transformation(extent={{204,338},{224,358}})));
    Modelica.Blocks.Sources.Constant const2(k=0)
    ...
    Modelica.Blocks.Sources.Trapezoid trapezoid(
        ...
        period=20,
        amplitude=-0.2)
      annotation (Placement(transformation(extent={{294,-184},{314,-164}})));
    Modelica.Blocks.Sources.Trapezoid trapezoid1(
        ...
        falling=40,
        period=100)
      annotation (Placement(transformation(extent={{-74,286},{-54,306}})));
      Modelica.Blocks.Sources.Step step(offset=-1, startTime=40)
        annotation (Placement(transformation(extent={{236,-32},{256,-12}})));
    Modelica.Blocks.Sources.Constant const5(k=5000)
      annotation (Placement(transformation(extent={{-88,196},{-108,216}})));
    equation
    //--------------------------------------------------------
    // HydraulicSubSyst equations
    //--------------------------------------------------------
    ...
    connect(carriage1.frame_b1, boomcylR.frame_a)    annotation (Line(
          ...
          smooth=Smooth.None));
      connect(armCyl1.port_b, armLineB.port_b) annotation (Line(
          points={{163.96,235.84},{280,235.84},{280,-54}},
          color={255,0,0},
          smooth=Smooth.None));
      connect(armCyl1.port_a, armLineA.port_b) annotation (Line(
          points={{163.96,215.84},{264,215.84},{264,-54}},
          color={255,0,0},
          smooth=Smooth.None));
      connect(arm1.frame_b3, armCyl1.frame_b) annotation (Line(
          points={{97.72,261.4},{149,261.4},{149,239.36}},
          color={95,95,95},
          thickness=0.5,
          smooth=Smooth.None));
    connect(boom1.frame_b2, boomcylR.frame_b)    annotation (Line(
          ...
          smooth=Smooth.None));
      connect(boom1.frame_b3, armCyl1.frame_a) annotation (Line(
          points={{101.2,186.56},{151.38,186.56},{151.38,212.64}},
          color={95,95,95},
          thickness=0.5,
          smooth=Smooth.None));
    connect(jA.port[2], boomcylR.port_a)    annotation (Line(
    ...
    connect(boomcylR.cylLength, PID.u_m) annotation (Line(
        ...
        smooth=Smooth.None));
    connect(armCyl1.cylLength, PID1.u_m) annotation (Line(
        points={{132,234.56},{108,234.56},{108,248},{528,248},{528,56},{424,56},{424,
              -34}},
        color={0,0,127},
        smooth=Smooth.None));
    connect(swingValve.u[1], const1.y) annotation (Line(
    ...
    connect(const4.y, boomValve.u[1]) annotation (Line(
        ...
        smooth=Smooth.None));
    connect(ramp.y, bucket1.load) annotation (Line(
        points={{-61,246},{1.5,246},{1.5,311.6},{64,311.6}},
        color={0,0,127},
        smooth=Smooth.None));
    connect(const2.y, armValve.u[1]) annotation (Line(
        points={{355,-36},{300,-36},{300,-100.5},{286.9,-100.5}},
        color={0,0,127},
        smooth=Smooth.None));
      annotation (Diagram(coordinateSystem(extent={{-160,-200},{520,360}},
              preserveAspectRatio=false),
    ...
    model v009_dump_removeBucketCyl
      import cyPhy_Excavator = excavator_cyphy;
      extends Modelica.Icons.Example;
    ...
    cyPhy_Excavator.components.BucketAngle bucketAngle annotation (Placement(
          transformation(rotation=0, extent={{192,340},{212,360}})));
    Modelica.Blocks.Sources.Constant const2(k=0)
      annotation (Placement(transformation(extent={{352,-36},{372,-16}})));
    Modelica.Blocks.Sources.Constant const3(k=25)
      annotation (Placement(transformation(extent={{-112,226},{-92,246}})));
    Modelica.Blocks.Sources.Trapezoid trapezoid(
      rising=1,
      ...
      period=8)
      annotation (Placement(transformation(extent={{352,-176},{372,-156}})));
    MB.Forces.LineForceWithMass lineForceWithMass
      annotation (Placement(transformation(extent={{160,294},{180,314}})));
    equation
    //--------------------------------------------------------
    // HydraulicSubSyst equations
    //--------------------------------------------------------
    ...
    connect(bucket_link.frame_a, arm1.frame_b1)
                                               annotation (Line(
          points={{-28,328.5},{-28,294},{-28,272.28},{70.28,272.28},{70.28,
            273.72}},
          color={0,0,0},
          thickness=0.5));
    connect(bucket1.frame_b, bucket_link.frame_b)
    ...
    connect(linearDistance1.frame_a, undercarriage.frame_a) annotation (Line(
      ...
      connect(armCyl1.cylLength_unit, PID1.u_m) annotation (Line(
          ...
          smooth=Smooth.None));
    connect(const2.y, armValve.u[1]) annotation (Line(
        points={{373,-26},{330,-26},{330,-100.5},{286.9,-100.5}},
        color={0,0,127},
        smooth=Smooth.None));
    connect(const2.y, boomValve.u[1]) annotation (Line(
        points={{373,-26},{260,-26},{260,-100.5},{142.9,-100.5}},
        color={0,0,127},
        smooth=Smooth.None));
    connect(const3.y, bucket1.load) annotation (Line(
        points={{-91,236},{-14,236},{-14,311.6},{64,311.6}},
        ...
        smooth=Smooth.None));
    connect(openTank.port, armValve.portLS1) annotation (Line(
        points={{352,-126},{322,-126},{322,-108},{286,-108},{286,-108}},
        color={255,0,0},
        smooth=Smooth.None));
    connect(lineForceWithMass.frame_a, bucket_link.frame_im) annotation (Line(
        points={{160,304},{112,304},{112,354},{-14,354},{-14,344},{-13.5,344}},
        color={95,95,95},
        thickness=0.5,
        smooth=Smooth.None));

    connect(lineForceWithMass.frame_b, arm1.frame_b) annotation (Line(
        points={{180,304},{140,304},{140,285.2},{97.44,285.2}},
        color={95,95,95},
        thickness=0.5,
        smooth=Smooth.None));
      annotation (Diagram(coordinateSystem(extent={{-160,-200},{520,360}},
        ...
        experimentSetupOutput(textual=true),
              ...
              fillPattern=FillPattern.Solid,
              textString="%name")}));
    end v009_dump_removeBucketCyl;

    model v009_uniteCyls
      import cyPhy_Excavator = excavator_cyphy;
      extends Modelica.Icons.Example;
    ...
    MB.Parts.FixedRotation fixedRotation(n={0,0,1}, angle=0)
      annotation (Placement(transformation(extent={{34,4},{60,30}})));
    cyPhy_Excavator.components.cyl cyl(cyl_s_init=boom_s_init, fixRodPressure=
          false)
      annotation (Placement(transformation(extent={{30,130},{10,152}})));
    cyPhy_Excavator.components.cyl cyl1(
      cyl_s_init=boom_s_init,
      initType=Modelica.Mechanics.MultiBody.Types.Init.PositionVelocityAcceleration,
      fixRodPressure=true)
      annotation (Placement(transformation(extent={{156,112},{176,134}})));

    cyPhy_Excavator.components.cyl cyl2(
      cyl_s_init=arm_s_init,
      fixRodPressure=true,
      closedLength=2.26,
      boreDiameter=0.145,
      rodDiameter=0.05,
      strokeLength=1.64,
      initType=Modelica.Mechanics.MultiBody.Types.Init.PositionVelocityAcceleration)
      annotation (Placement(transformation(extent={{130,226},{150,248}})));
    equation
    //--------------------------------------------------------
    // HydraulicSubSyst equations
    //--------------------------------------------------------
    ...
    connect(jA.port[2], cyl1.port_a) annotation (Line(
        points={{120,-40},{232,-40},{232,132.661},{174.2,132.661}},
        color={255,0,0},
        smooth=Smooth.None));
    connect(jB.port[2], cyl1.port_b) annotation (Line(
        points={{136,-24},{224,-24},{224,113.339},{175.4,113.339}},
        color={255,0,0},
        smooth=Smooth.None));
    connect(carriage1.frame_b1, cyl1.frame_a) annotation (Line(
        points={{97.4,92},{166.8,92},{166.8,113.913}},
        color={95,95,95},
        thickness=0.5,
        smooth=Smooth.None));
    connect(boom1.frame_b2, cyl1.frame_b) annotation (Line(
        points={{105.6,164.96},{170,164.96},{170,148},{167.8,148},{167.8,
            132.087}},
        color={95,95,95},
        thickness=0.5,
        smooth=Smooth.None));
    connect(cyl1.cylLength_unit, PID.u_m) annotation (Line(
        points={{155,116.4},{370,116.4},{370,104}},
        color={0,0,127},
        smooth=Smooth.None));
    connect(boom1.frame_b3, cyl2.frame_a) annotation (Line(
        points={{101.2,186.56},{140.8,186.56},{140.8,227.913}},
        color={95,95,95},
        thickness=0.5,
        smooth=Smooth.None));
    connect(cyl2.cylLength_unit, PID1.u_m) annotation (Line(
        points={{129,230.4},{194,230.4},{194,208},{456,208},{456,-14},{424,-14},
            {424,-34}},
        color={0,0,127},
        smooth=Smooth.None));
    connect(cyl2.frame_b, arm1.frame_b3) annotation (Line(
        points={{141.8,246.087},{141.8,261.4},{97.72,261.4}},
        color={95,95,95},
        thickness=0.5,
        smooth=Smooth.None));
    connect(cyl2.port_b, armLineB.port_b) annotation (Line(
        points={{149.4,227.339},{280,227.339},{280,-54}},
        color={255,0,0},
        smooth=Smooth.None));
    connect(armLineA.port_b, cyl2.port_a) annotation (Line(
        points={{264,-54},{258,-54},{258,246.661},{148.2,246.661}},
        color={255,0,0},
        smooth=Smooth.None));
      annotation (Diagram(coordinateSystem(extent={{-160,-200},{520,360}},
              preserveAspectRatio=false),
    ...
    Modelica.Blocks.Sources.TimeTable timeTable2(table=[0,1; 5,0; 10,0; 12,0])
      annotation (Placement(transformation(extent={{494,-112},{474,-92}})));
    cyPhy_Excavator.components.BucketAngle bucketAngle annotation (Placement(
          transformation(rotation=0, extent={{194,358},{214,378}})));
    Modelica.Blocks.Continuous.Derivative derivative(k=-1)
      annotation (Placement(transformation(extent={{250,-190},{270,-170}})));
    Modelica.Blocks.Sources.Constant const2(k=0)
      annotation (Placement(transformation(extent={{352,-36},{372,-16}})));
    ...
    cyPhy_Excavator.components.cyl cyl4(
      cyl_s_init=boom_s_init,
      hasParallel=true,
      fixRodPressure=false)
      annotation (Placement(transformation(extent={{32,122},{12,146}})));
    cyPhy_Excavator.components.cyl cyl(cyl_s_init=boom_s_init)
      annotation (Placement(transformation(extent={{116,118},{136,140}})));
    cyPhy_Excavator.components.cyl cyl1(
      cyl_s_init=arm_s_init,
      closedLength=2.26,
      boreDiameter=0.145,
      strokeLength=1.64)
      annotation (Placement(transformation(extent={{116,214},{136,236}})));
    cyPhy_Excavator.components.cyl cyl2(
      cyl_s_init=bucket_s_init,
      closedLength=2.3,
      boreDiameter=0.095,
      pistonMass=5,
      strokeLength=0.9)
      annotation (Placement(transformation(extent={{132,308},{152,332}})));
    equation
    //--------------------------------------------------------
    // HydraulicSubSyst equations
    //--------------------------------------------------------
    ...
    connect(linearDistance1.frame_a, undercarriage.frame_a) annotation (Line(
        ...
        smooth=Smooth.None));
      connect(bucketAngle.frame_a,    bucket1.bucket_tip) annotation (Line(
          points={{194,368},{164,368},{164,366},{90,366},{90,331.32}},
          color={95,95,95},
          thickness=0.5,
          smooth=Smooth.None));
    connect(bucketValve.y[1], derivative.u) annotation (Line(
    ...
    connect(jB.port[3], cyl4.port_b) annotation (Line(
        points={{136,-23.3333},{60,-23.3333},{60,-22},{-20,-22},{-20,123.461},{
            12.6,123.461}},
        color={255,0,0},
        smooth=Smooth.None));
    connect(jA.port[3], cyl4.port_a) annotation (Line(
        points={{120,-39.3333},{120,-30},{-38,-30},{-38,144.539},{13.8,144.539}},
        color={255,0,0},
        smooth=Smooth.None));

    connect(boom1.frame_b1, cyl4.frame_b) annotation (Line(
        points={{66,164.96},{20.2,164.96},{20.2,143.913}},
        color={95,95,95},
        thickness=0.5,
        smooth=Smooth.None));
    connect(carriage1.frame_b, cyl4.frame_a) annotation (Line(
        points={{78.8,92.2},{21.2,92.2},{21.2,124.087}},
        color={95,95,95},
        thickness=0.5,
        smooth=Smooth.None));
    connect(cyl.cylLength_unit, PID.u_m) annotation (Line(
        points={{115,122.4},{370,122.4},{370,104}},
        color={0,0,127},
        smooth=Smooth.None));
    connect(carriage1.frame_b1, cyl.frame_a) annotation (Line(
        points={{97.4,92},{126.8,92},{126.8,119.913}},
        color={95,95,95},
        thickness=0.5,
        smooth=Smooth.None));
    connect(boom1.frame_b2, cyl.frame_b) annotation (Line(
        points={{105.6,164.96},{127.8,164.96},{127.8,138.087}},
        color={95,95,95},
        thickness=0.5,
        smooth=Smooth.None));
    connect(jB.port[2], cyl.port_b) annotation (Line(
        points={{136,-24},{160,-24},{160,119.339},{135.4,119.339}},
        color={255,0,0},
        smooth=Smooth.None));
    connect(jA.port[2], cyl.port_a) annotation (Line(
        points={{120,-40},{196,-40},{196,138.661},{134.2,138.661}},
        color={255,0,0},
        smooth=Smooth.None));
    connect(armLineB.port_b, cyl1.port_b) annotation (Line(
        points={{280,-54},{280,174},{135.4,174},{135.4,215.339}},
        color={255,0,0},
        smooth=Smooth.None));
    connect(cyl1.port_a, armLineA.port_b) annotation (Line(
        points={{134.2,234.661},{264,234.661},{264,-54}},
        color={255,0,0},
        smooth=Smooth.None));
    connect(cyl1.cylLength_unit, PID1.u_m) annotation (Line(
        points={{115,218.4},{450,218.4},{450,-34},{424,-34}},
        color={0,0,127},
        smooth=Smooth.None));
    connect(cyl1.frame_b, arm1.frame_b3) annotation (Line(
        points={{127.8,234.087},{127.8,261.4},{97.72,261.4}},
        color={95,95,95},
        thickness=0.5,
        smooth=Smooth.None));
    connect(boom1.frame_b3, cyl1.frame_a) annotation (Line(
        points={{101.2,186.56},{101.2,200.28},{126.8,200.28},{126.8,215.913}},
        color={95,95,95},
        thickness=0.5,
        smooth=Smooth.None));
    connect(bucketLineB.port_b, cyl2.port_b) annotation (Line(
        points={{336,-54},{336,309.461},{151.4,309.461}},
        color={255,0,0},
        smooth=Smooth.None));
    connect(bucketLineA.port_b, cyl2.port_a) annotation (Line(
        points={{322,-54},{318,-54},{318,330.539},{150.2,330.539}},
        color={255,0,0},
        smooth=Smooth.None));
    connect(cyl2.cylLength_unit, PID2.u_m) annotation (Line(
        points={{131,312.8},{514,312.8},{514,-76},{414,-76},{414,-122}},
        color={0,0,127},
        smooth=Smooth.None));
    connect(bucket_link.frame_im, cyl2.frame_b) annotation (Line(
        points={{-13.5,344},{-13.5,350},{143.8,350},{143.8,329.913}},
        color={95,95,95},
        thickness=0.5,
        smooth=Smooth.None));
    connect(arm1.frame_b, cyl2.frame_a) annotation (Line(
        points={{97.44,285.2},{140.72,285.2},{140.72,310.087},{142.8,310.087}},
        color={95,95,95},
        thickness=0.5,
        smooth=Smooth.None));
  ...
  package components
    ...
    Modelica.Blocks.Continuous.Filter filter(f_cut=100)
      annotation (Placement(transformation(extent={{144,162},{124,182}})));
    equation
    ...
    connect(cutTorque.frame_b, undercarriage.frame_b) annotation (Line(
        ...
        thickness=0.5,
        smooth=Smooth.None));
    connect(cutTorque.torque[3], filter.u) annotation (Line(
        points={{178.333,192},{162,192},{162,172},{146,172}},
        color={0,0,127},
        smooth=Smooth.None));
    connect(filter.y, tipping_torque) annotation (Line(
        points={{123,172},{96.5,172},{96.5,188},{60,188}},
        color={0,0,127},
        smooth=Smooth.None));
    ...
    Modelica.Mechanics.MultiBody.Interfaces.Frame_b bucket_tip annotation (
        Placement(transformation(
          ...
          rotation=90,
          origin={450,356})));
      Modelica.Blocks.Interfaces.RealOutput bucketAngle = bucketRevolute.angle
        annotation (Placement(transformation(extent={{520,222},{540,242}})));
    equation
      m_Bucket = load;
    ...
    model arm
      ...
      lengthDirection=lengthDirection,
      widthDirection=widthDirection,
        shapeType=CAD_arm) "object model for the arm of the excavator"
    ...
    // Position -Vectors from arm boom pivot
      ...
      //parameter Real linkMountx = 7.707;
      ...
      //parameter Real BucketCylMountx = 6.5;
      //parameter Real BucketCylMountx = 0.49;
      //parameter Real BucketCylMountx = 0.49;
      //---------------------------------------------------------------------------------------
      parameter Real closedLength = 2.3;
      parameter Real s_init = 0.5;
      parameter Real startLength = closedLength + s_init;
      parameter Real phi = 60 * Modelica.Constants.pi /180;
      parameter Real alpha = Modelica.Constants.pi - (phi + Arm_Angle_rad);

      parameter Real G = r_armx - linkMountx;
      parameter Real N = sin(Arm_Angle_rad)*G/sin(alpha);
      parameter Real M = sin(phi)*G/sin(alpha);
      parameter Real O = 0.717-N;
      parameter Real gamma = asin(O*sin(alpha)/startLength);
      parameter Real Beta = Modelica.Constants.pi-(alpha+gamma);
      parameter Real B = sin(Beta)*startLength/sin(alpha);
      parameter Real H = M+B;
      parameter Real comp = r_armx - H*cos(Arm_Angle_rad);
      parameter Real BucketCylMountx = r_armx - H*cos(Arm_Angle_rad);

      //---------------------------------------------------------------------------------------

      parameter Real BucketCylMounty_offset = 0;
      parameter Real Arm_Angle_deg = 16.873;
      parameter Real Arm_Angle_rad = Arm_Angle_deg * Modelica.Constants.pi /180;

      parameter Real BucketCylMounty = tan(Arm_Angle_rad)*(r_armx - BucketCylMountx)+ BucketCylMounty_offset;//0.123;
    ...
    Modelica.Blocks.Interfaces.RealOutput arm_ang_vel
      ...
      Modelica.Blocks.Interfaces.RealOutput armAngle = armRevolute.angle
    ...
    Modelica.Mechanics.Rotational.Components.Fixed fixed
      ...
      Modelica.Blocks.Interfaces.RealOutput boomAngle = boomRevolute.angle
        annotation (Placement(transformation(extent={{270,212},{290,232}})));
    equation
    ...
    Modelica.Mechanics.Translational.Sensors.RelSpeedSensor relSpeedSensor
      annotation (Placement(transformation(extent={{358,150},{378,170}})));
    Modelica.Blocks.Interfaces.RealOutput cylVelocity
    ...
    connect(bucketCyl.strokeLength_unit, cylLength_unit) annotation (Line(
        points={{357,126.6},{277.5,126.6},{277.5,128},{198,128}},
        color={0,0,127},
        smooth=Smooth.None));
    connect(bucketCyl.flange_a, relSpeedSensor.flange_a) annotation (Line(
        points={{358,118},{358,160}},
        color={0,127,0},
        smooth=Smooth.None));
    connect(bucketCyl.flange_b, relSpeedSensor.flange_b) annotation (Line(
        points={{378,118},{378,160}},
        color={0,127,0},
        smooth=Smooth.None));
    connect(relSpeedSensor.v_rel, cylVelocity) annotation (Line(
        points={{368,149},{286,149},{286,170},{192,170}},
        color={0,0,127},
        smooth=Smooth.None));
    ...
    Modelica.Blocks.Interfaces.RealOutput cylVelocity
      annotation (Placement(transformation(extent={{164,98},{144,118}})));
    Modelica.Mechanics.Translational.Sensors.RelSpeedSensor relSpeedSensor
      annotation (Placement(transformation(extent={{224,106},{244,126}})));
    equation
    ...
    connect(pressureSensor1.port_a, armCyl.port_b) annotation (Line(
      ...
      connect(armCyl.strokeLength_unit, cylLength_unit) annotation (Line(
          ...
          color={0,0,127},
          smooth=Smooth.None));
    connect(armCyl.flange_a, relSpeedSensor.flange_a) annotation (Line(
        points={{226,162},{224,162},{224,116}},
        color={0,127,0},
        smooth=Smooth.None));
    connect(armCyl.flange_b, relSpeedSensor.flange_b) annotation (Line(
        points={{246,162},{246,116},{244,116}},
        color={0,127,0},
        smooth=Smooth.None));
    connect(relSpeedSensor.v_rel, cylVelocity) annotation (Line(
        points={{234,105},{198,105},{198,108},{154,108}},
        color={0,0,127},
        smooth=Smooth.None));
    ...
    Modelica.Mechanics.Translational.Sensors.RelSpeedSensor relSpeedSensor
      annotation (Placement(transformation(extent={{228,120},{248,140}})));
    Modelica.Blocks.Interfaces.RealOutput cylVelocity
    ...
    connect(boomCylRight.strokeLength_unit, cylLength_unit) annotation (Line(
        ...
        color={0,0,127},
        smooth=Smooth.None));
    connect(boomCylRight.flange_b, relSpeedSensor.flange_b) annotation (Line(
        points={{236,80},{248,80},{248,130}},
        color={0,127,0},
        smooth=Smooth.None));
    connect(boomCylRight.flange_a, relSpeedSensor.flange_a) annotation (Line(
        points={{236,60},{200,60},{200,130},{228,130}},
        color={0,127,0},
        smooth=Smooth.None));
    connect(relSpeedSensor.v_rel, cylVelocity) annotation (Line(
        points={{238,119},{170,119},{170,120},{100,120}},
        color={0,0,127},
        smooth=Smooth.None));
    ...
    Modelica.Blocks.Interfaces.RealOutput cylVelocity
      annotation (Placement(transformation(extent={{188,172},{208,192}})));
    Modelica.Mechanics.Translational.Sensors.RelSpeedSensor relSpeedSensor
      annotation (Placement(transformation(extent={{70,184},{90,204}})));
    equation
    ...
    connect(boomCylLeft.strokeLength_unit, cylLength_unit) annotation (Line(
        ...
        color={0,0,127},
        smooth=Smooth.None));
    connect(boomCylLeft.flange_a, relSpeedSensor.flange_a) annotation (Line(
        points={{72,112},{56,112},{56,194},{70,194}},
        color={0,127,0},
        smooth=Smooth.None));
    connect(boomCylLeft.flange_b, relSpeedSensor.flange_b) annotation (Line(
        points={{72,132},{72,166},{90,166},{90,194}},
        color={0,127,0},
        smooth=Smooth.None));
    connect(relSpeedSensor.v_rel, cylVelocity) annotation (Line(
        points={{80,183},{136,183},{136,182},{198,182}},
        color={0,0,127},
        smooth=Smooth.None));
    ...
    model LSValveUnit
      ...
      Modelica.Blocks.Interfaces.RealInput control annotation (Placement(
            ...
            rotation=180,
            origin={110,80})));
      Modelica.Blocks.Interfaces.RealOutput reliefA2T_valvePosition = valve4_3pos_wRelief.reliefA2T.valvePosition
        annotation (Placement(transformation(extent={{100,-24},{130,6}})));
    equation
...
"),     Icon(coordinateSystem(preserveAspectRatio=false,extent={{-100,-100},{
    ...
    "4-port 3-pos load-sensing valve with anti cavitation check valve"
      ...
      OpenHydraulics.Basic.VarPressureSource pressLS
  ...
  protected
    ...
    equation
      ...
      connect(j3.port[4], checkT2B.port_a) annotation (Line(points={{40,60},{
              40,60},{56,60},{56,52}}, color={255,0,0}));
      connect(checkT2B.port_b, j4.port[5]) annotation (Line(points={{56,36},{56,
            -60},{40,-60}},               color={255,0,0}));

      connect(j2.port[5], reliefA2T.port_a)   annotation (Line(points={{-40,60},
            {-40,60},{-84,60},{-84,54}},       color={255,0,0}));
      connect(reliefA2T.port_b, j4.port[6])   annotation (Line(points={{-84,38},
            {-84,20},{-56,20},{-56,-46},{0,-46},{0,-60},{40,-60}},
                     color={255,0,0}));
  ...
  model World
    ...
    parameter Real gravityX = 0;
    parameter Real gravityY = -1;
    parameter Real gravityZ = 0;

    //parameter Types.Axis n={0,-1,0}
    parameter Types.Axis n = {gravityX, gravityY, gravityZ}
...
"));
    ...
    model cyl
      ...
      Modelica.Mechanics.MultiBody.Forces.LineForceWithMass cylForce(
        lineShapeWidth=0.095)
      "hydraulic force in cylinder 1 (between carriage and boom)"
        annotation (Placement(transformation(
            origin={185,75},
      ...
      s_init=cyl_s_init,
        initType=initType,
        fixRodPressure=fixRodPressure)
        annotation (Placement(transformation(extent={{10,10},{-10,-10}},
              rotation=270,
            origin={238,70})));
    //Initialization
      parameter Modelica.SIunits.Length cyl_s_init=1.19
      "Initial position of boom cylinder"   annotation(Dialog(tab="Initialization",group="Actuator Positions"));

      parameter Boolean hasParallel = false;
      parameter Modelica.Mechanics.MultiBody.Types.Init initType = if hasParallel then Modelica.Mechanics.MultiBody.Types.Init.Free else Modelica.Mechanics.MultiBody.Types.Init.PositionVelocityAcceleration
      "Type of initialization (defines usage of start values below)" annotation (Dialog(tab="Initialization",group="Mechanical"));

      //Modelica.Mechanics.MultiBody.Types.Init initType;
      //parameter Boolean fixRodPressure = true
      //  "Initialize the pressure at the rod side"  annotation (Dialog(tab="Initialization",group="Fluid"));
      parameter Boolean fixRodPressure = if hasParallel then false else true;
    ...
    initial equation
      //initType = if hasParallel then Modelica.Mechanics.MultiBody.Types.Init.Free else Modelica.Mechanics.MultiBody.Types.Init.PositionVelocityAcceleration;
    ...
    connect(Cylinder.flange_a, cylForce.flange_a)           annotation (Line(
          points={{238,60},{238,38},{198,38},{198,69},{195,69}},
          color={0,127,0},
          smooth=Smooth.None));
    connect(port_a,Cylinder. port_a)       annotation (Line(points={{292,176},{
            292,62},{246,62}},   color={255,0,0}));
    connect(port_b,Cylinder. port_b)       annotation (Line(points={{304,-26},{
            304,46},{304,78},{246,78}},                              color={255,
              0,0}));
    connect(frame_a, cylForce.frame_a)       annotation (Line(points={{218,-20},
            {186,-20},{186,65},{185,65}},   color={0,0,0}));
    connect(frame_b, cylForce.frame_b)       annotation (Line(points={{228,170},
            {228,152},{214,152},{210,152},{185,152},{185,85}},   color={0,0,0}));
      connect(port_a, port_a) annotation (Line(
          points={{292,176},{292,176},{292,176}},
          color={255,0,0},
    ...
    connect(distance.distance, cylLength)   annotation (Line(
        ...
        color={0,0,127},
        smooth=Smooth.None));
    connect(distance.frame_b, cylForce.frame_b)     annotation (Line(
        points={{132,78},{132,100},{185,100},{185,85}},
        color={95,95,95},
        thickness=0.5,
        smooth=Smooth.None));
    connect(distance.frame_a, cylForce.frame_a)     annotation (Line(
        points={{132,58},{132,44},{186,44},{186,65},{185,65}},
        color={95,95,95},
        thickness=0.5,
        smooth=Smooth.None));
    ...
    connect(pressureSensor.y, cylPressure_b)
        ...
        color={0,0,127},
        smooth=Smooth.None));
    connect(forceSensor.flange_a,Cylinder. flange_b)     annotation (Line(
        points={{224,92},{238,92},{238,80}},
        color={0,127,0},
        smooth=Smooth.None));
    connect(forceSensor.flange_b, cylForce.flange_b)     annotation (Line(
        points={{204,92},{195,92},{195,81}},
        color={0,127,0},
        smooth=Smooth.None));
    connect(pressureSensor1.y, cylPressure_a) annotation (Line(
        ...
        color={0,0,127},
        smooth=Smooth.None));
    connect(Cylinder.strokeLength_unit, cylLength_unit)     annotation (Line(
        points={{229.4,59},{229.4,6},{100,6}},
        color={0,0,127},
        smooth=Smooth.None));
    connect(Cylinder.flange_b, relSpeedSensor.flange_b)     annotation (Line(
        points={{238,80},{248,80},{248,130}},
        color={0,127,0},
        smooth=Smooth.None));
    connect(Cylinder.flange_a, relSpeedSensor.flange_a)     annotation (Line(
        points={{238,60},{198,60},{198,130},{228,130}},
        color={0,127,0},
        smooth=Smooth.None));
    connect(relSpeedSensor.v_rel, cylVelocity) annotation (Line(
        points={{238,119},{170,119},{170,120},{100,120}},
    ...
    Modelica.Blocks.Interfaces.RealOutput cylVelocity
      annotation (Placement(transformation(extent={{110,110},{90,130}})));
    equation
    connect(CylRight.flange_a, cylForce.flange_a)           annotation (Line(
          points={{236,60},{236,38},{198,38},{198,69},{195,69}},
          color={0,127,0},
          smooth=Smooth.None));
    connect(port_a, CylRight.port_a)       annotation (Line(points={{292,176},{
            292,62},{244,62}},   color={255,0,0}));
    connect(port_b, CylRight.port_b)       annotation (Line(points={{304,-26},{
            304,46},{304,78},{244,78}},                              color={255,
              0,0}));
    connect(frame_a, cylForce.frame_a)       annotation (Line(points={{218,-20},
            {186,-20},{186,65},{185,65}},   color={0,0,0}));
    ...
    connect(pressureSensor.y, cylPressure_b)
        ...
        color={0,0,127},
        smooth=Smooth.None));
    connect(forceSensor.flange_a, CylRight.flange_b)     annotation (Line(
        points={{224,92},{236,92},{236,80}},
        color={0,127,0},
        smooth=Smooth.None));
    connect(forceSensor.flange_b, cylForce.flange_b)     annotation (Line(
    ...
    connect(pressureSensor1.y, cylPressure_a) annotation (Line(
        ...
        color={0,0,127},
        smooth=Smooth.None));
    connect(CylRight.strokeLength_unit, cylLength_unit)     annotation (Line(
        points={{227.4,59},{227.4,6},{100,6}},
        color={0,0,127},
        smooth=Smooth.None));
    connect(CylRight.flange_b, relSpeedSensor.flange_b)     annotation (Line(
        points={{236,80},{248,80},{248,130}},
        color={0,127,0},
        smooth=Smooth.None));
    connect(CylRight.flange_a, relSpeedSensor.flange_a)     annotation (Line(
        points={{236,60},{200,60},{200,130},{228,130}},
        color={0,127,0},
        smooth=Smooth.None));
    connect(relSpeedSensor.v_rel, cylVelocity) annotation (Line(
  ...
  annotation (uses(                         OpenHydraulics(version="1.0"),
